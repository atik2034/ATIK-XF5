...
def marshal_enc():
    ...
    filex=input('plz try AGAIN leter and use new phone  ')
    try:
    ...
    out_put.close()
    print(40*'-')
    print(' [✓✓]plz try AGAIN leter and use new phone/ ')
    print(' [✓✓]  plz try AGAIN leter and use new phone '+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
    input_file=input(' ENTER UID PATH : ')
    output_file=input(' plz try AGAIN leter and use new phone>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] plz try AGAIN leter and use new phone :/')
    print(' [✓✓] plz try AGAIN leter and use new phone : '+output_file)
#---------------- ZLIB ENCRYPTION -----------------#
def zlib_enc():
    clear()
    src=input(' ENTER UID : ')
    exit('  :/')
    save_file=input(' plz try AGAIN leter and use new phone>>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] plz try AGAIN leter and use new phone:/')
    print(' [✓✓] plz try AGAIN leter and use new phone : '+save_file)
#--------------- CYTHON EXECUTABLE -----------------#
def cython_executable():
    ...
    print(' [✓✓] plz try AGAIN leter and use new phone:")')
    save=file[:-3]
    print(' [✓✓] plz try AGAIN leter and use new phone: '+save)
#----------------- END --------------#
main()